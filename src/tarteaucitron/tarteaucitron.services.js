  ...
  js: function () {
    ...
    tarteaucitron.addScript(
      ...
      function () {
        ...
        _kTck.setBridge(
          "https://" +
            tarteaucitron.user.madmetricsHostname +
            "/k_redirect_md.php",
        );
        _kTck.track();
      },
...
tarteaucitron.services.kompass = {
  ...
  js: function () {
    ...
    tarteaucitron.addScript(
      "https://fr.kompass.com/leads/script.js?id=" +
        tarteaucitron.user.kompassId,
    );
  },
};
...
tarteaucitron.services.weply = {
  ...
  js: function () {
    ...
    tarteaucitron.addScript(
      "https://app.weply.chat/widget/" + tarteaucitron.user.weplyId,
    );
  },
};
...
tarteaucitron.services.trustpilot = {
  ...
  fallback: function () {
    ...
    tarteaucitron.fallback(["trustpilot-widget"], function (elem) {
      elem.style.width = tarteaucitron.getStyleSize(
        tarteaucitron.getElemAttr(elem, "data-style-width"),
      );
      elem.style.height = tarteaucitron.getStyleSize(
        tarteaucitron.getElemAttr(elem, "data-style-height"),
      );
      return tarteaucitron.engage(id);
    });
  },
...
tarteaucitron.services.plausible = {
  ...
  js: function () {
    ...
    tarteaucitron.addScript(
      "https://" + tarteaucitron.user.plausibleEndpoint + "/js/script.js",
      "",
      "",
      "",
      "data-domain",
...
tarteaucitron.services.aduptech_conversion = {
  ...
  js: function () {
    ...
    for (var i = 0; i < elements.length; i++) {
      ...
      if (
        !tarteaucitron.getElemAttr(element, "advertiserId") ||
        !tarteaucitron.getElemAttr(element, "conversionCode")
      ) {
        continue;
      }
      ...
      if (tarteaucitron.getElemAttr(element, "price")) {
        url +=
          "&price=" +
          encodeURIComponent(tarteaucitron.getElemAttr(element, "price"));
      }

      if (tarteaucitron.getElemAttr(element, "quantity")) {
        url +=
          "&quantity=" +
          encodeURIComponent(tarteaucitron.getElemAttr(element, "quantity"));
      }

      if (tarteaucitron.getElemAttr(element, "total")) {
        url +=
          "&total=" +
          encodeURIComponent(tarteaucitron.getElemAttr(element, "total"));
      }

      if (tarteaucitron.getElemAttr(element, "orderId")) {
        url +=
          "&order_id=" +
          encodeURIComponent(tarteaucitron.getElemAttr(element, "orderId"));
      }

      if (tarteaucitron.getElemAttr(element, "itemNumber")) {
        url +=
          "&item_number=" +
          encodeURIComponent(tarteaucitron.getElemAttr(element, "itemNumber"));
      }

      if (tarteaucitron.getElemAttr(element, "description")) {
        url +=
          "&description=" +
          encodeURIComponent(tarteaucitron.getElemAttr(element, "description"));
      }
    ...
    window.AdUpRetargeting = function (api) {
      for (var i = 0; i < elements.length; i++) {
        ...
        if (tarteaucitron.getElemAttr(element, "product")) {
          try {
            api.setProduct(
              JSON.parse(tarteaucitron.getElemAttr(element, "product")),
            );
          } catch (e) {
        ...
        if (tarteaucitron.getElemAttr(element, "transaction")) {
          try {
            api.setTransaction(
              JSON.parse(tarteaucitron.getElemAttr(element, "transaction")),
            );
          } catch (e) {
            api.setTransaction(
              tarteaucitron.getElemAttr(element, "transaction"),
            );
          }
        }
        ...
        if (tarteaucitron.getElemAttr(element, "device")) {
          var setter =
            "set" +
            tarteaucitron
              .getElemAttr(element, "device")
              .charAt(0)
              .toUpperCase() +
            tarteaucitron.getElemAttr(element, "device").slice(1);
        ...
        if (tarteaucitron.getElemAttr(element, "track")) {
          var tracker =
            "track" +
            tarteaucitron
              .getElemAttr(element, "track")
              .charAt(0)
              .toUpperCase() +
            tarteaucitron.getElemAttr(element, "track").slice(1);
...
tarteaucitron.services.clicmanager = {
  ...
  js: function () {
    ...
    for (i = 0; i < uniqIds.length; i += 1) {
      ...
      uri +=
        "c=" +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), "c") +
        "&";
      uri +=
        "s=" +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), "s") +
        "&";
      uri +=
        "t=" +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), "t");
...
tarteaucitron.services.artetv = {
  ...
  js: function () {
    ...
    tarteaucitron.fallback(["artetv_player"], function (x) {
      ...
      var styleAttr =
        (video_width !== ""
          ? "width:" + tarteaucitron.getStyleSize(video_width) + ";"
          : "") +
        (video_height !== ""
          ? "height:" + tarteaucitron.getStyleSize(video_height) + ";"
          : "");
...
tarteaucitron.services.datingaffiliationpopup = {
  ...
  js: function () {
    ...
    for (i = 0; i < uniqIds.length; i += 1) {
      ...
      uri +=
        "ur=" +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), "ur") +
        "&";
      uri +=
        "brand=" +
        tarteaucitron.getElemAttr(
      ...
      uri +=
        "lang=" +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), "lang") +
        "&";
      uri +=
        "cf0=" +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), "cf0") +
        "&";
      uri +=
        "cf2=" +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), "cf2") +
        "&";
      uri +=
        "subid1=" +
        tarteaucitron.getElemAttr(
      ...
      uri +=
        "bt=" +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), "bt") +
        "&";
      uri +=
        "vis=" +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), "vis") +
        "&";
      uri +=
        "hid=" +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), "hid") +
        "&";
      uri +=
        "snd=" +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), "snd") +
        "&";
      uri +=
        "aabd=" +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), "aabd") +
        "&";
      uri +=
        "aabs=" +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), "aabs");
...
tarteaucitron.services.deezer = {
  ...
  js: function () {
    ...
    tarteaucitron.fallback(["deezer_player"], function (x) {
      ...
      if (deezer_height !== "") {
        styleAttr +=
          "height:" + tarteaucitron.getStyleSize(deezer_height) + ";";
      }
      if (
        embed_theme === "" ||
...
tarteaucitron.services.googlemapsembed = {
  ...
  fallback: function () {
    ...
    tarteaucitron.fallback(["googlemapsembed"], function (elem) {
      elem.style.width = tarteaucitron.getStyleSize(
        tarteaucitron.getElemWidth(elem),
      );
      elem.style.height = tarteaucitron.getStyleSize(
        tarteaucitron.getElemHeight(elem),
      );
      return tarteaucitron.engage(id);
    });
  },
...
tarteaucitron.services.hubspot = {
  ...
  js: function () {
    ...
    if (
      tarteaucitron.user.hubspotBusinessUnitId !== undefined &&
      tarteaucitron.user.hubspotBusinessUnitId !== null &&
      tarteaucitron.user.hubspotBusinessUnitId !== ""
    ) {
      tac_businessUnitId =
        "?businessUnitId=" + tarteaucitron.user.hubspotBusinessUnitId;
    }

    tarteaucitron.addScript(
      "//js.hs-scripts.com/" +
        tarteaucitron.user.hubspotId +
        ".js" +
        tac_businessUnitId,
      "hs-script-loader",
    );
...
tarteaucitron.services.pubdirecte = {
  ...
  js: function () {
    ...
    for (i = 0; i < uniqIds.length; i += 1) {
      ...
      uri +=
        "id=" +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), "pid") +
        "&";
      uri +=
        "ref=" +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), "ref");
...
tarteaucitron.services.rumbletalk = {
  ...
  js: function () {
    ...
    tarteaucitron.fallback(["rumbletalk"], function (x) {
      ...
      return (
        '<div style="height: ' +
        tarteaucitron.getStyleSize(height) +
        "; width: " +
        tarteaucitron.getStyleSize(width) +
        ';"><div id="' +
        id +
        '"></div></div>'
      );
...
tarteaucitron.services.soundcloud = {
  ...
  js: function () {
    ...
    tarteaucitron.fallback(["soundcloud_player"], function (x) {
      var frame_title =
        ...
        frame_height =
          "height:" + tarteaucitron.getStyleSize(player_height) + ";",
  ...
  fallback: function () {
    ...
    tarteaucitron.fallback(["soundcloud_player"], function (elem) {
      elem.style.height = tarteaucitron.getStyleSize(
        tarteaucitron.getElemAttr(elem, "data-height"),
      );
...
tarteaucitron.services.spotify = {
  ...
  js: function () {
    ...
    tarteaucitron.fallback(["spotify_player"], function (x) {
      ...
      if (spotify_height !== "") {
        styleAttr +=
          "height:" + tarteaucitron.getStyleSize(spotify_height) + ";";
      }
      spotify_frame =
        '<iframe title="' +
        frame_title +
...
tarteaucitron.services.twitterembed = {
  ...
  fallback: function () {
    ...
    tarteaucitron.fallback(["twitterembed-canvas"], function (elem) {
      elem.style.width = tarteaucitron.getStyleSize(
        tarteaucitron.getElemAttr(elem, "data-width"),
      );
      return tarteaucitron.engage(id);
    });
  },
...
tarteaucitron.services.matterport = {
  ...
  js: function () {
    ...
    tarteaucitron.fallback(["matterport"], function (x) {
      ...
      if (matterport_width !== "") {
        styleAttr +=
          "width:" + tarteaucitron.getStyleSize(matterport_width) + ";";
      }
      if (matterport_height !== undefined) {
        styleAttr +=
          "height:" + tarteaucitron.getStyleSize(matterport_height) + ";";
      }
...
tarteaucitron.services.bandcamp = {
  ...
  js: function () {
    ...
    tarteaucitron.fallback(["bandcamp_player"], function (x) {
      ...
      if (bandcamp_width !== "") {
        styleAttr +=
          "width:" + tarteaucitron.getStyleSize(bandcamp_width) + ";";
      }
      if (bandcamp_height !== "") {
        styleAttr +=
          "height:" + tarteaucitron.getStyleSize(bandcamp_height) + ";";
      }
