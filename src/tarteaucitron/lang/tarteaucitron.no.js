...
tarteaucitron.lang = {
  middleBarHead: "☝️ 🍪",
  adblock:
    "Hei! Dette nettstedet er gjennomsiktig og lar deg kontrollere hvilke tredjeparts tjenester du vil tillate.",
  adblock_call:
  ...
  disclaimer:
    "Ved å tillate disse tredjepartstjenestene godtar du informasjonskapslene deres og bruken av sporingsteknologier som er nødvendige for at de skal fungere korrekt.",
  allow: "Tillat",
  deny: "Ikke tillat",
  ...
  ads: {
    ...
    details:
      "Annonsenettverket kan generere inntekter ved å selge reklameplass på nettstedet.",
  },
  analytic: {
    title: "Målgruppe målinger",
    details:
      "Målgruppens målingstjenester ble brukt til å generere nyttig informasjon for å forbedre nettstedet.",
  },
  social: {
    title: "Sosiale nettverk",
    details:
      "Sosiale nettverk kan forbedre brukervennligheten til nettstedet og bidra til å markedsføre det.",
  },
  video: {
    title: "Video",
    details:
      "Videodelingstjenester hjelper til med å legge til rik media på nettstedet og øke synligheten.",
  },
  comment: {
    title: "Kommentarer",
    details:
      "Kommentaradministratorer legger til rette for arkivering av kommentarer og bekjemper spam.",
  },
  support: {
    title: "Brukerstøtte",
    details:
      "Brukerstøtte lar deg komme i kontakt med nettstedsteamet og bidra til å forbedre nettstedet.",
  },
  api: {
    title: "API-er",
    details:
  ...
  google: {
    ...
    details:
      "Google kan bruke dataene dine til måling av publikum, reklameprestasjoner eller til å tilby deg personlig tilpassede annonser.",
  },

  mandatoryTitle: "Obligatoriske informasjonskapsler",
  mandatoryText:
    "Dette nettstedet bruker obligatoriske informasjonskapsler som er nødvendige for at nettstedet skal fungere som det skal. Disse kan ikke deaktiveres.",
