...
tarteaucitron.lang = {
  middleBarHead: "☝️ 🍪",
  adblock:
    "Witaj! Ta witryna oferuje daje mozliwość wyboru aktywacji usług zewnętrznych.",
  adblock_call:
    "Prosze wylaczyc adblocker aby rozpoczac dostosowanie do potrzeb uzytkownika.",
  ...
  disclaimer:
    "Zgadzając się na korzystanie z usług zewnętrznych, akceptujesz ich pliki cookies oraz wykorzystanie technologii śledzących, niezbędnych do ich funkcjonowania.",
  allow: "Zezwalaj",
  deny: "Odmów",
  ...
  noServices:
    "Ta strona nie wykorzystuje żadnych plików cookie wymagających Twojej zgody.",
  ...
  ads: {
    ...
    details:
      "Sieci reklamowe mogą generować przychody ze sprzedaży powierzchni reklamowej na stronie.",
  },
  analytic: {
    title: "Pomiar oglądalności",
    details:
      "Usługi pomiaru oglądalności wykorzystywane są do generowania przydatnych statystyk potrzebnych w doskonaleniu strony.",
  },
  social: {
    title: "Portale społecznościowe",
    details:
      "Sieci społecznościowe mogą poprawić użyteczność serwisu i pomóc w promocji za pośrednictwem udostępniania strony.",
  },
  video: {
    title: "Filmy",
    details:
  ...
  support: {
    title: "Pomoc",
    details:
      "Usługa pomocy technicznej pozwala skontaktować się z administratorem witryny i pomaga ją udoskonalić.",
  },
  api: {
    title: "APIs",
    details:
      "APIs służą do ładowania skryptów: geolokalizacji, wyszukiwarek, tłumaczenia, ...",
  },
  other: {
    title: "Inne",
  ...
  google: {
    ...
    details:
      "Google może wykorzystywać Twoje dane do pomiaru zasięgu, wydajności reklamowej lub oferowania spersonalizowanych reklam.",
  },

  mandatoryTitle: "obowiązkowe pliki cookie",
  mandatoryText:
    "Ta strona wykorzystuje pliki cookies niezbędne do jej prawidłowego funkcjonowania, których nie można wyłączyć.",
