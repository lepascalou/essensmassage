...
tarteaucitron.lang = {
  middleBarHead: "☝️ 🍪",
  adblock:
    "Hei! Tämä sivusto antaa sinun valita ja hallita kolmansien osapuolten asettamia evästeitä.",
  ...
  alertBigPrivacy:
    "Tämä sivusto käyttää evästeitä ja antaa sinun hallita niitä.",
  ...
  disclaimer:
    "Hyväksymällä kolmansien osapuolten palvelut, hyväksyt toiminnan kannalta tarpeellisten evästeiden ja seurantateknologioiden käytön.",
  allow: "Hyväksy",
  deny: "Kiellä",
  ...
  ads: {
    ...
    details:
      "Mainosverkostot saattavat saada tuloja myymällä mainostilaa sivustolla.",
  },
  analytic: {
    title: "Yleisön mittaaminen",
    details:
      "Yleisömittauspalveluja käytetään kävijätilastojen tuottamiseen, joista on hyötyä sivuston parantamisessa.",
  },
  social: {
    title: "Sosiaaliset verkostot",
    details:
      "Sosiaaliset verkostot voivat helpottaa sivuston käytettävyyttä ja mainontaa",
  },
  video: {
    title: "Videot",
    details:
      "Videoiden toistopalvelut auttavat rikastamaan sivuston markkinointia ja kasvattaa sen näkyvyyttä",
  },
  ...
  comment: {
    ...
    details:
      "Kommentoinnin ylläpito helpottaa kommenttien arkistointia ja roskapostin hallintaa.",
  },
  support: {
    title: "Tuki",
    details:
      "Ohjelmointirajapintoja käytetään eri ohjelmistojen, kuten hakukoneiden, sijaintien tai käännösten, lataamiseen.",
  },
  api: {
  ...
  google: {
    ...
    details:
      "Google voi käyttää tietojasi yleisön mittaamiseen, mainosvaikutusten arviointiin tai tarjotakseen sinulle personoituja mainoksia.",
  },

  mandatoryTitle: "Tarpeelliset evästeet",
  mandatoryText:
    "Tämä sivusto käyttää evästeitä, jotka ovat välttämättömiä sen asianmukaisen toiminnan kannalta. Niitä ei voi poistaa käytöstä.",
