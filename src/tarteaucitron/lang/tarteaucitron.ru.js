...
tarteaucitron.lang = {
  middleBarHead: "☝️ 🍪",
  adblock:
    "Привет! Этот сайт совершенно открытый и позволяет вам выбрать сервисы третьих лиц, которым вы хотите дать доступ.",
  ...
  disclaimer:
    "Активирование сервисов третьих лиц позволяет использование их кукис и технолоний отслеживания необходимых для их функционирования",
  allow: "Позволить",
  deny: "Не позволить",
  ...
  noServices:
    "Этот веб-сайт не использует файлы cookie, требующие вашего согласия.",
  ...
  analytic: {
    ...
    details:
      "Измерение аудиенции сайта для статистики помогают улучшить предлагаемый сервис.",
  },
  social: {
    title: "Социальная сеть",
    details:
      "Социальная сеть сайтов помогает улучшить предлагаемый сервис через обмен информации.",
  },
  video: {
    title: "Видео",
    details:
      "Обмен видео информации позволяет улучшить сервис и увеличит траффик сайта.",
  },
  comment: {
    title: "Комментарии",
    details:
      "Манаджер комментариев позволяет обмен информации и борьбу со спамом.",
  },
  support: {
    title: "Помощь",
    details:
      "Помощь позволяет вам контактировать напрямую сайт манаджер и улучшить предлагаемый сервис.",
  },
  api: {
    title: "АПИ",
    details:
      "АПИ используются для загрузки скриптов; геолокация, поисковый мотор и переводы...",
  },
  other: {
    title: "Другие",
  ...
  google: {
    ...
    details:
      "Google может использовать ваши данные для измерения аудитории, оценки рекламной эффективности или предоставления вам персонализированных рекламных объявлений.",
  },

  mandatoryTitle: "Обязательные файлы cookie",
  mandatoryText:
    "Этот сайт использует файлы cookie, необходимые для его правильной работы, которые нельзя отключить.",
