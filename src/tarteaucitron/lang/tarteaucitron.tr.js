...
tarteaucitron.lang = {
  middleBarHead: "☝️ 🍪",
  adblock:
    "Merhaba! Bu site şeffaflıkla oynar ve size etkinleştirilecek üçüncü taraf hizmetleri seçeneği sunar.",
  adblock_call:
    "Kişiselleştirmeye başlamak için lütfen reklam engelleyicinizi devre dışı bırakın.",
  reload: "Sayfayı yeniden yükle",

  alertBigScroll: "Kaydırma devam edien,",
  alertBigClick: "Navigasyonunuza devam ederek,",
  alertBig:
    "çerez yükleyebilecek üçüncü taraf hizmetlerinin kullanımını kabul edersiniz",

  alertBigPrivacy:
    "Bu site çerezleri kullanır ve etkinleştirmek istediklerinizi kontrol etmenizi sağlar",
  ...
  ads: {
    ...
    details:
      "Reklam ajansları, sitedeki reklam alanını pazarlayarak gelir elde etmenizi sağlar.",
  },
  analytic: {
    title: "Kitle ölçümü",
    details:
      "Kitle ölçüm hizmetleri, siteyi geliştirmek için yararlı katılım istatistikleri oluşturur.",
  },
  social: {
    title: "Sosyal Medya",
    details:
  ...
  video: {
    title: "Videolar",
    details:
      "Video paylaşım hizmetleri siteyi multimedya içeriğiyle zenginleştirir ve görünürlüğünü artırır.\n" +
      "\n",
  },
  comment: {
    title: "yorumlar\n",
    details:
      "Yorum yöneticileri yorumlarınızın gönderilmesini kolaylaştırır ve spam ile mücadele eder.",
  },
  support: {
    title: "destek",
    details:
      "Destek hizmetleri, site ekibiyle iletişim kurmanıza ve ekibinizi geliştirmenize yardımcı olur.\n" +
      "\n",
  },
  api: {
    title: "APIs",
    details:
      "APIs komut dosyalarının yüklenmesine izin verir: coğrafi konum, arama motorları, çeviriler, ...",
  },
  other: {
    title: "diğer\n",
  ...
  google: {
    ...
    details:
      "Google, verilerinizi izleyici ölçümü, reklam performansı veya size kişiselleştirilmiş reklamlar sunmak için kullanabilir.",
  },

  mandatoryTitle: "Zorunlu Çerezler",
  mandatoryText:
    "Bu site, düzgün çalışması için gerekli olan ve devre dışı bırakılamayan çerezleri kullanır.",
