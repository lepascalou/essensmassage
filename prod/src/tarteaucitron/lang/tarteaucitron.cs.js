...
tarteaucitron.lang = {
  middleBarHead: "☝️ 🍪",
  adblock:
    "Ahoj! Tato stránka je transparetní a umožňuje ti si přímo vybrat, jaké služby třetích stran chceš povolit.",
  ...
  alertBigPrivacy:
    "Tato stránka využívá cookies a dává ti na výběr, co chceš aktivovat",
  ...
  disclaimer:
    "Povolením těchto služeb třetích stran, přijímáš jejich cookies, jež jsou nezbytné pro řádné fungování jejich technologií.",
  allow: "Povolit",
  deny: "Zamítnout",
  ...
  noServices:
    "Tento web nepoužívá žádné soubory cookie vyžadující váš souhlas.",
  ...
  ads: {
    title: "Reklamní síť",
    details:
      "Prodejem reklamních ploch na této stránce mohou reklamní sítě vydělávat peníze.",
  },
  analytic: {
    title: "Statistika návštěvnosti",
    details:
      "Služby pro analýzu návštěvníků slouží k vytvoření užitečných statistik návštěvnosti. Ty zase slouží ke zlepšení stránky.",
  },
  social: {
    title: "Sociální sítě",
    details:
      "Sociální sítě mohou usnadnit práci se stránkou a pomáhají jí prosadit se pomocí sdílení.",
  },
  video: {
    title: "Videa",
    details:
      "Video-hostingové služby pomáhají přidat na stránku bohaté mediální prvky.",
  },
  comment: {
    title: "Komentáře",
    details:
      "Správce komentářů zajišťují vyplňování komentářů a bojují proti šíření spamu.",
  },
  support: {
    title: "Podpora",
    details:
      "Služby podpory ti pomáhají spojit se s týmem stojícím za stránkou a umožňují ti vyjádřit se k jejím nedostatkům.",
  },
  api: {
    title: "API",
    details:
      "API slouží k načtění skriptů: geolokace, vyhledávačů, překladů, ...",
  },
  other: {
    title: "Jiný",
  ...
  google: {
    ...
    details:
      "Google může využívat vaše údaje k měření publika, reklamnímu účinku nebo k zobrazení personalizovaných reklam.",
  },

  mandatoryTitle: "Povinné soubory cookie",
  mandatoryText:
    "Tato stránka používá soubory cookie nezbytné pro její správné fungování, které nelze deaktivovat.",
