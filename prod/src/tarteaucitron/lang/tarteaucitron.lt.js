...
tarteaucitron.lang = {
  middleBarHead: "☝️ 🍪",
  adblock:
    "Sveiki! Ši svetainė veikia skaidriai ir leidžia pasirinkti trečiosios šalies paslaugas, kurias norite leisti.",
  ...
  alertBigPrivacy:
    "Ši svetainė naudoja slapukus ir suteikia jums galimybę valdyti, ką norite suaktyvinti",
  ...
  disclaimer:
    "Leisdami šias trečiųjų šalių paslaugas, jūs sutinkate su jų slapukais ir sekimo technologijų naudojimu, reikalingu jų tinkamam veikimui.",
  allow: "Leisti",
  deny: "Atsisakyti",
  ...
  noServices:
    "Šioje svetainėje nenaudojami jokie slapukai, kuriems reikalingas jūsų sutikimas.",
  ...
  ads: {
    ...
    details:
      "Reklamos tinklai gali gauti pajamų, parduodami reklamos vietą svetainėje.",
  },
  analytic: {
    title: "Auditorijos matavimas",
    details:
      "Naudotos auditorijos vertinimo paslaugos generuoti naudingą statistinį lankomumą svetainės veiklos patobulinimui.",
  },
  social: {
    title: "Socialiniai tinklai",
    details:
      "Socialiniai tinklai gali pagerinti svetainės naudojimą ir padėti ją reklamuoti per akcijas.",
  },
  video: {
    title: "Vaizdo įrašai",
    details:
      "Vaizdo įrašų bendrinimo paslaugos padeda pritraukti gausesnę media į svetainę ir padidinti jos matomumą.",
  },
  comment: {
    title: "Komentarai",
    details:
      "Komentarų valdytojai palengvina komentarų sisteminimą ir kovoja su šlamštu.",
  },
  support: {
    title: "Pagalba",
    details:
      "Pagalbos paslaugos leidžia jums susisiekti su svetainės komanda ir padėti ją tobulinti.",
  },
  api: {
    title: "APIs (Aplikacijų programavimo sąsajos)",
    details:
      "API naudojamos tekstams įkelti: geografinė padėtis, paieškos sistemos, vertimai, ...",
  },
  other: {
    title: "Kita",
  ...
  google: {
    ...
    details:
      "„Google“ gali naudoti jūsų duomenis auditorijos matavimui, reklamos veiklos vertinimui arba jums siūlomiems asmeniškai pritaikytiems skelbimams.",
  },

  mandatoryTitle: "Privalomi slapukai",
  mandatoryText:
    "Ši svetainė naudoja slapukus, reikalingus tinkamam jos veikimui, kurių negalima išjungti.",
