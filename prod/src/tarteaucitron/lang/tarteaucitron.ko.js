...
tarteaucitron.lang = {
  middleBarHead: "☝️ 🍪",
  adblock:
    "안녕하세요? 이 사이트는 투명성을 지향하며 귀하가 제 3자 서비스의 활성화에 대한 선택을 할 수 있도록 합니다",
  ...
  alertBigPrivacy:
    "이 사이트는 쿠키를 사용하며 귀하가 활성화하려는 쿠키를 제어할 수 있습니다",
  alertSmall: "서비스 관리",
  personalize: "설정 변경",
  acceptAll: "모두 수락",
  close: "닫기",
  ...
  info: "개인 정보 보호",
  disclaimer:
    "이러한 제3자 서비스를 허용함으로써 귀하는 쿠키의 저장 및 읽기와 쿠키의 올바른 기능에 필요한 추적 기술의 사용을 허용하게 됩니다..",
  allow: "허용",
  deny: "거부",
  ...
  ads: {
    title: "광고 대행사",
    details:
      "광고 대행사는 사이트의 광고 공간의 마케팅을 통해 수익창출을 돕습니다",
  },
  analytic: {
    title: "독자 측정",
  ...
  social: {
    title: "소셜 네트워크",
    details:
      "소셜 네트워크는 사이트의 사용자 친화성을 높이고 공유를 통해 사이트를 홍보하는 데 도움이 됩니다.",
  },
  video: {
    title: "동영상",
    details:
      "동영상 공유 서비스는 멀티미디어 콘텐츠로 사이트를 풍부하게 하고 가시성을 높입니다.",
  },
  comment: {
    title: "댓글",
    details:
      "댓글 관리자는 귀하의 댓글 게시를 용이하게 하고 스팸을 방지합니다.",
  },
  support: {
    title: "지원",
    details:
      "지원 서비스를 통해 사이트 관리팀과 연락하여 사이트 개선에 도움을 줄 수 있습니다.",
  },
  api: {
    title: "APIs",
  ...
  google: {
    ...
    details:
      "구글은 잠재고객 측정, 광고 성과 또는 개인 맞춤 광고 제공을 위해 귀하의 데이터를 사용할 수 있습니다.",
  },

  mandatoryTitle: "필수 쿠키",
  mandatoryText:
    "이 사이트는 올바른 작동을 위해 필요한 쿠키들을 사용합니다. 이 쿠키들은 비활성화할 수 없습니다.",
