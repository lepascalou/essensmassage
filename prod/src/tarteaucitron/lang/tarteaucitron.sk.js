...
tarteaucitron.lang = {
  middleBarHead: "☝️ 🍪",
  adblock:
    "Ahoj! Táto stránka je transparentná a umožňuje vám vybrať služby tretích strán, ktoré chcete povoliť.",
  ...
  alertBigPrivacy:
    "Táto stránka používa cookies a dáva vám kontrolu nad tým, čo chcete aktivovať",
  ...
  disclaimer:
    "Povolením týchto služieb tretích strán, prijímate ich cookies a používanie sledovacích technológií potrebných pre ich správne fungovanie.",
  allow: "Povoliť",
  deny: "Odmietnúť",
  ...
  noServices:
    "Táto webová stránka nepoužíva žiadny súbor cookie, ktorý vyžaduje váš súhlas.",
  ...
  ads: {
    title: "Reklamná sieť",
    details:
      "Reklamné siete môžu generovať príjmy predajom reklamného priestoru na webe.",
  },
  analytic: {
    title: "Meranie publika",
    details:
      "Služby merania publika používané na generovanie užitočnej štatistickej účasti na zlepšenie stránky.",
  },
  social: {
    title: "Sociálne siete",
    details:
      "Sociálne siete môžu zlepšiť použiteľnosť stránky a pomôcť ju propagovať prostredníctvom akcií.",
  },
  video: {
    title: "Videá",
    details:
      "Služby zdieľania videa pomáhajú pridať na web bohatý obsah a zvýšiť jeho viditeľnosť.",
  },
  comment: {
    title: "Komentáre",
    details:
      "Manažéri komentárov uľahčujú zadávanie komentárov a bojujú proti spamu.",
  },
  support: {
    title: "Podpora",
    details:
      "Podporné služby vám umožňujú skontaktovať sa s tímom stránok a pomôcť vám ich vylepšiť.",
  },
  api: {
    title: "APIs",
    details:
      "Rozhrania API sa používajú na načítanie skriptov: geolokácia, vyhľadávače, preklady, ...",
  },
  other: {
    title: "Ostatné",
  ...
  google: {
    ...
    details:
      "Google môže použiť vaše údaje na meranie publika, reklamnú efektivitu alebo na vám ponúkanie personalizovaných reklám.",
  },

  mandatoryTitle: "Povinné súbory cookie",
  mandatoryText:
    "Táto stránka používa súbory cookie, ktoré sú nevyhnutné pre jej správne fungovanie a nemôžu byť deaktivované.",
